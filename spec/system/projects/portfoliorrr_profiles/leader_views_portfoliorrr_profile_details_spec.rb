...
describe 'Líder de projeto vê detalhes de um perfil da Portfoliorrr' do
  ...
  it 'com sucesso a partir da home' do
    ...
    mateus_profile = PortfoliorrrProfile.new id: 2, name: 'Rodolfo', job_category: 'Designer'
    allow(PortfoliorrrProfile).to receive(:all).and_return([mateus_profile])
    ...
    allow(PortfoliorrrProfile).to receive(:find).and_return(mateus_profile)
